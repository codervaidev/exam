            ...
            <div class="flex-1 flex flex-col items-start">
                ...
                <div class="flex items-center mb-5 md:mb-6">
                    <span
                        ...
                        <span>
                            ৫৪৩৫ জন শিক্ষার্থী পরীক্ষা দিয়ে ফেলেছে ইতিমধ্যে
                        </span>
                    </span>
                </div>
                <p class="text-base md:text-lg text-white/90 leading-relaxed drop-shadow-sm max-w-2xl">
                    প্রকল্প ব্যবস্থাপনায় ক্যারিয়ার দ্রুত অগ্রসর হন। এই সার্টিফিকেট প্রোগ্রামে, আপনি চাহিদাসম্পন্ন
                    দক্ষতা শিখবেন এবং তাৎক্ষণিক প্রশিক্ষণ পাবেন। প্রকল্প ব্যবস্থাপনায় ক্যারিয়ারে দ্রুত অগ্রসর হন। এই
                    সার্টিফিকেট প্রোগ্রামে, আপনি চাহিদাসম্পন্ন দক্ষতা শিখবেন এবং তাৎক্ষণিক প্রশিক্ষণ পাবেন।
                </p>
            </div>
...
<script setup>
const { data } = await useFetch('/api/exams/next');
