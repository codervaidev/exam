        ...
        <CardContent class="flex-grow p-4 sm:p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div
                    ...
                    <div
                        class="flex items-center mb-1 sm:mb-2 text-xs sm:text-sm font-semibold text-blue-700 dark:text-blue-300">
                ...
                <div
                    ...
                    <div
                        class="flex items-center mb-1 sm:mb-2 text-xs sm:text-sm font-semibold text-red-700 dark:text-red-300">
                        <Icon name="lucide:calendar" class="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
                        End
                    </div>
                    <div class="ml-5 sm:ml-6 text-xs sm:text-sm font-medium text-red-600 dark:text-red-400">{{
                ...
                <div
                    ...
                    <div
                        class="flex items-center mb-1 sm:mb-2 text-xs sm:text-sm font-semibold text-green-700 dark:text-green-300">
                        <Icon name="lucide:clock" class="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
                        Duration
                    </div>
                    <div class="ml-5 sm:ml-6 text-xs sm:text-sm font-medium text-green-600 dark:text-green-400">{{
                ...
                <div
                    ...
                    <div
                        class="flex items-center mb-1 sm:mb-2 text-xs sm:text-sm font-semibold text-yellow-700 dark:text-yellow-300">
            ...
            <div v-if="exam.status !== 'past'" class="flex flex-col items-center rounded-xl">
            ...
            <template v-if="exam.status === 'past'">
                ...
                <div class="sm:hidden w-full gap-3">
                    ...
                    <div class="grid grid-cols-2 gap-3 w-full">
                        <Button @click="navigateTo(`/exam/${exam.id}/solution`)"
                            v-if="new Date(exam.solution_publish_time) < new Date()"
                            class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105">
                            Solution
                        </Button>
                        <Button @click="navigateTo(`/exam/${exam.id}/leaderboard`)"
                            v-if="new Date(exam.result_publish_time) < new Date()"
                            class="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105">
                            Leaderboard
                        </Button>
                    </div>
